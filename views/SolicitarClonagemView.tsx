        ...
        <div className="space-y-10 animate-in fade-in duration-700 pb-20">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 px-4">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h1 className="text-3xl font-display font-bold text-white uppercase tracking-tight">Clonagem <span className="text-primary text-glow">Personalizada</span></h1>
                ...
                <div className="bg-surface-dark border border-white/5 px-8 py-5 rounded-[2rem] flex items-center gap-4 shadow-xl">
                    <div className="text-right">
                        <p className="text-[9px] text-gray-500 font-bold uppercase tracking-widest">Saldo Disponível</p>
                        <p className="text-2xl font-display font-bold text-green-500">{balance.toFixed(2)} <span className="text-xs uppercase">DC</span></p>
                    </div>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-surface-dark/40 backdrop-blur-xl border border-white/5 rounded-[3rem] p-10 md:p-16 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-4xl font-display font-bold text-white uppercase tracking-tighter mb-2">Solicitar Clonagem</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3">
                                <label className="flex items-center gap-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/40 border border-white/5 rounded-2xl px-6 py-5 text-sm text-white focus:border-primary outline-none transition-all placeholder:text-gray-700"
                                />
                            </div>
                            <div className="space-y-3">
                                <label className="flex items-center gap-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">
                        ...
                        <div className="space-y-3">
                            ...
                            <textarea
                                ...
                                className="w-full bg-black/40 border border-white/5 rounded-2xl px-6 py-5 text-sm text-white focus:border-primary outline-none transition-all placeholder:text-gray-700 resize-none"
                            />
                        </div>

                        <div className="bg-gradient-to-br from-indigo-950/30 to-black/50 border border-indigo-500/20 p-8 rounded-[2rem] flex flex-col items-center justify-center text-center gap-4">
                            <div className="flex items-center gap-3">
                                <span className="text-4xl font-display font-bold text-white">250.00</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    { icon: 'palette', title: 'Personalização', desc: 'Adaptado às suas necessidades específicas', color: 'text-green-500' },
                    { icon: 'shield_lock', title: 'Segurança', desc: 'Pagamento seguro com Dark Coins', color: 'text-blue-500' },
                    { icon: 'support_agent', title: 'Suporte', desc: 'Suporte completo durante todo o processo', color: 'text-purple-500' },
                ].map((feat, i) => (
                    <div key={i} className="bg-surface-dark border border-white/5 p-8 rounded-[2rem] text-center group hover:bg-surface-dark-2 transition-all">
                        <div className={`w-12 h-12 ${feat.color} bg-white/5 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}>
